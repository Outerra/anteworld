...
#ifndef _INTERGEN_GENERATED__dynamic_object_H_
#define _INTERGEN_GENERATED__dynamic_object_H_
...
public:
    ...
    //@param colliding true if object should have collisions
    ...
    static const int HASHID = 4032331899u;

    ///Interface name (full ns::class string)
    static const coid::tokenhash& IFCNAME() {
        static const coid::tokenhash _name = "ot::dynamic_object"_T;
        return _name;
    }
    ...
    static const coid::token& intergen_default_creator_static( backend bck ) {
        ...
        static constexpr coid::token _djs("ot::dynamic_object@wrapper.js"_T);
        static constexpr coid::token _djsc("ot::dynamic_object@wrapper.jsc"_T);
        static constexpr coid::token _dlua("ot::dynamic_object@wrapper.lua"_T);
    ...
    static int register_client()
    {
        ...
        coid::charstr tmp = "ot::dynamic_object"_T;
        tmp << "@client-4032331899"_T << '.' << type;
...
protected:
    ...
    ///Cleanup routine called from ~dynamic_object()
    static void _cleaner_callback(dynamic_object* m, intergen_interface* ifc) {
        m->assign_safe(ifc, 0);
    }

    bool assign_safe(intergen_interface* client__, iref<dynamic_object>* pout);

    typedef void (*cleanup_fn)(dynamic_object*, intergen_interface*);
    cleanup_fn _cleaner = 0;

    bool set_host(policy_intrusive_base*, intergen_interface*, iref<dynamic_object>* pout);
...
inline iref<T> dynamic_object::_get( T* _subclass_, void* mo )
{
    ...
    static constexpr coid::token ifckey = "ot::dynamic_object._get@4032331899"_T;
    ...
    if (!create) {
        log_mismatch("_get"_T, "ot::dynamic_object._get"_T, "@4032331899"_T);
        return 0;
    }
...
inline iref<T> dynamic_object::create( T* _subclass_, const coid::token& objpath, const double3& pos, const glm::quat& rot )
{
    ...
    static fn_creator create = 0;
    static constexpr coid::token ifckey = "ot::dynamic_object.create@4032331899"_T;
    ...
    if (!create) {
        log_mismatch("create"_T, "ot::dynamic_object.create"_T, "@4032331899"_T);
        return 0;
    }
...
inline ot::objcat dynamic_object::type() const
...
inline pkg::geomob* dynamic_object::get_pkg_geomob() const
...
inline double3 dynamic_object::get_pos() const
...
inline glm::quat dynamic_object::get_rot() const
...
inline void dynamic_object::set_fps_camera_pos( const float3& pos, uint joint_id, ot::EJointRotationMode joint_rotation )
{ return VT_CALL(void,(const float3&,uint,ot::EJointRotationMode),20)(pos,joint_id,joint_rotation); }

inline void dynamic_object::set_fps_camera_rot( const quat& rot, ot::ERotationMode mouse_rotation )
{ return VT_CALL(void,(const quat&,ot::ERotationMode),21)(rot,mouse_rotation); }

inline void dynamic_object::set_fps_camera_fov( float hfov, float vfov )
...
inline quat dynamic_object::get_fps_camera_rot( bool base ) const
{ return VT_CALL(quat,(bool) const,24)(base); }

inline float2 dynamic_object::get_fps_camera_fov() const
...
inline void dynamic_object::fetch_controls( coid::dynarray32<int32>& buf, bool append )
{ return VT_CALL(void,(coid::dynarray32<int32>&,bool),31)(buf,append); }
...
inline bool dynamic_object::is_script_enabled() const
{ return VT_CALL(bool,() const,40)(); }

inline void dynamic_object::enable_script( bool en )
{ return VT_CALL(void,(bool),41)(en); }

inline void dynamic_object::attach_to( iref<ot::object>& obj, uint joint_id )
{ return VT_CALL(void,(iref<ot::object>&,uint),42)(obj,joint_id); }

inline void dynamic_object::extra_force( const float3& mpos, const float3& force, bool worldspace )
{ return VT_CALL(void,(const float3&,const float3&,bool),43)(mpos,force,worldspace); }

inline void dynamic_object::extra_impulse( const float3& mpos, const float3& impulse, bool worldspace )
{ return VT_CALL(void,(const float3&,const float3&,bool),44)(mpos,impulse,worldspace); }

inline float3 dynamic_object::com_offset() const
{ return VT_CALL(float3,() const,45)(); }

inline btCollisionObject* dynamic_object::collision_object() const
{ return VT_CALL(btCollisionObject*,() const,46)(); }

#pragma warning(pop)

} //namespace

#endif //_INTERGEN_GENERATED__dynamic_object_H_
