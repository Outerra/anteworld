...
#ifndef _INTERGEN_GENERATED__tracker_H_
#define _INTERGEN_GENERATED__tracker_H_
...
public:
    ...
    static const int HASHID = 4104556368u;

    ///Interface name (full ns::class string)
    static const coid::tokenhash& IFCNAME() {
        static const coid::tokenhash _name = "ot::tracker"_T;
        return _name;
    }
    ...
    static const coid::token& intergen_default_creator_static( backend bck ) {
        ...
        static constexpr coid::token _djs("ot::tracker@wrapper.js"_T);
        static constexpr coid::token _djsc("ot::tracker@wrapper.jsc"_T);
        static constexpr coid::token _dlua("ot::tracker@wrapper.lua"_T);
    ...
    static int register_client()
    {
        ...
        coid::charstr tmp = "ot::tracker"_T;
        tmp << "@client-4104556368"_T << '.' << type;
...
protected:
    ...
    ///Cleanup routine called from ~tracker()
    static void _cleaner_callback(tracker* m, intergen_interface* ifc) {
        m->assign_safe(ifc, 0);
    }

    bool assign_safe(intergen_interface* client__, iref<tracker>* pout);

    typedef void (*cleanup_fn)(tracker*, intergen_interface*);
    cleanup_fn _cleaner = 0;

    bool set_host(policy_intrusive_base*, intergen_interface*, iref<tracker>* pout);
};
...
inline iref<T> tracker::create( T* _subclass_, const char* name )
{
    ...
    static constexpr coid::token ifckey = "ot::tracker.create@4104556368"_T;
    ...
    if (!create) {
        log_mismatch("create"_T, "ot::tracker.create"_T, "@4104556368"_T);
        return 0;
    }
...
#endif //_INTERGEN_GENERATED__tracker_H_
