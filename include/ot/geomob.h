...
{ return VT_CALL(void,(uint),26)(joint); }

inline void geomob::rotate_joint( uint joint, float angle, const float3& vec, bool orig )
{ return VT_CALL(void,(uint,float,const float3&,bool),27)(joint,angle,vec,orig); }
