...
public:
    ...
    static const int HASHID = 2308668110;
...
inline iref<T> geomob::create( T* _subclass_, const coid::token& url, coid::uint parent_id, coid::uint parent_joint_id )
{
    ...
    static const coid::token ifckey = "ot::geomob.create@2308668110";
    ...
    if (!create) {
        log_mismatch("create", "ot::geomob.create", "@2308668110");
        return 0;
    }
...
inline iref<T> geomob::create2( T* _subclass_, const coid::token& url, coid::uint parent_id, coid::uint parent_joint_id, double3 pos, quat rot )
{
    ...
    static fn_creator create = 0;
    static const coid::token ifckey = "ot::geomob.create2@2308668110";
    ...
    if (!create) {
        log_mismatch("create2", "ot::geomob.create2", "@2308668110");
        return 0;
    }
...
inline iref<T> geomob::create3( T* _subclass_, const coid::token& url, coid::uint parent_id, const coid::token& parent_joint, double3 pos, quat rot )
{
    ...
    static fn_creator create = 0;
    static const coid::token ifckey = "ot::geomob.create3@2308668110";
    ...
    if (!create) {
        log_mismatch("create3", "ot::geomob.create3", "@2308668110");
        return 0;
    }
...
inline iref<T> geomob::from_entity_id( T* _subclass_, coid::uint entity_id )
{
    ...
    static fn_creator create = 0;
    static const coid::token ifckey = "ot::geomob.from_entity_id@2308668110";
    ...
    if (!create) {
        log_mismatch("from_entity_id", "ot::geomob.from_entity_id", "@2308668110");
        return 0;
    }
...
inline iref<T> geomob::_get_instance_interface( T* _subclass_, void* so )
{
    ...
    static fn_creator create = 0;
    static const coid::token ifckey = "ot::geomob._get_instance_interface@2308668110";
    ...
    if (!create) {
        log_mismatch("_get_instance_interface", "ot::geomob._get_instance_interface", "@2308668110");
        return 0;
    }
...
{ return VT_CALL(void,(uint,uint),96)(light_block_id,rgbi); }

inline void geomob::turn_off_block( uint light_block_id )
{ return VT_CALL(void,(uint),97)(light_block_id); }

inline void geomob::turn_off_lightmap()
{ return VT_CALL(void,(),98)(); }

inline void geomob::set_material_variant( uint index )
{ return VT_CALL(void,(uint),99)(index); }
