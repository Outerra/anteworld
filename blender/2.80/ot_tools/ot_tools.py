...
class OtMirrorOnOffPanel(bpy.types.Panel):
    bl_idname = "PANEL_PT_OtMirrorOnOffPanel"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
...
class OtSolidifyOnOffPanel(bpy.types.Panel):
    bl_idname = "PANEL_PT_OtSolidifyOnOffPanel"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
...
class OtDisplayMirrorModifiersOn(bpy.types.Operator):
    '''Display all mirror modifiers'''
    bl_idname = "view3d.ot_display_mirror_modifiers_on"
    bl_label = "On"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
...
class OtDisplayMirrorModifiersOff(bpy.types.Operator):
    '''Hide all mirror modifiers'''
    bl_idname = "view3d.ot_display_mirror_modifiers_off"
    bl_label = "Off"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
...
class OtDisplayArrayModifiersOff(bpy.types.Operator):
...
class OtDisplaySolidifyModifiersOn(bpy.types.Operator):
...
class OtDisplaySolidifyModifiersOff(bpy.types.Operator):
...
class OtObjectControlsPanel(bpy.types.Panel):
    bl_idname = "PANEL_PT_OtObjectControlsPanel"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
...
class OtCollisionMeshControlsPanel(bpy.types.Panel):
    bl_idname = "PANEL_PT_OtCollisionMeshControlsPanel"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
...
class OtAddLodCurveProperties(bpy.types.Operator):
...
class OtAddCollisionMeshProperties(bpy.types.Operator):
...
class OtVegetationPanel(bpy.types.Panel):
    bl_idname = "PANEL_PT_OtVegetationPanel"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
...
class OtVegetationComputeWeights(bpy.types.Operator):
...
class OtOtherToolsPanel(bpy.types.Panel):
    bl_idname = "PANEL_PT_OtOtherToolsPanel"
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "OT tools"
