...
{ 
	...
	//	action - path to input binding (config_file/group/action) where:
    ...
    //Warning: "register_axis" events are called with value 0 when the script loads or reloads. To prevent issues, when using functionality that toggles value, you can add a check to ignore these initial events by adding condition "if (v === 0) { return; }"
