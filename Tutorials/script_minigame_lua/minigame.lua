...
function ot.script_module:on_before_reload()
    ...
    -- In lua script, method "on_before_reload" needs to return an array (user data), which is then passed to method "on_after_reload" (can be empty array)...
    return {}
end
