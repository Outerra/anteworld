...
//We recommend reviewing the Outerra/anteworld tutorial on Github ( https://github.com/Outerra/anteworld/wiki/Tutorial-1-%E2%80%90-Vehicle-(Cpp) ) before proceeding, as it provides detailed informations
